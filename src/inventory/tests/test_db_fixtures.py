...
def test_inventory_category_dbfixture(
    ...
    """Test the fixtures for the category db work correctly."""
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            " porta, eros vel sollicitudin lacinia, quam metus gravida elit, a"
            " elementum nisl neque sit amet orci. Nulla id lorem ac nunc"
            " cursus consequat vitae ut orci. In a velit eu justo eleifend"
            " tincidunt vel eu turpis. Praesent eu orci egestas, lobortis"
            " magna egestas, tincidunt augue. Vestibulum ante ipsum primis in"
            " faucibus orci luctus et ultrices posuere cubilia curae; Aenean"
            " vitae lectus eget tortor laoreet efficitur vel et leo. Maecenas"
            " volutpat eget ante id tempor. Etiam posuere ex urna, at aliquet"
            " risus tempor eu. Aenean a odio odio. Nunc consectetur lorem"
            " ante, interdum ultrices elit consectetur sit amet. Vestibulum"
            " rutrum interdum nulla. Cras vel mi a enim eleifend blandit."
            " Curabitur ex dui, rutrum et odio sit amet, auctor euismod"
            " massa.",
            1,
            "2021-09-04 22:14:18",
            "2021-09-04 22:14:18",
...
def test_inventory_db_product_uniqueness_integrity(db, product_factory):
    """Test that every product has a unique web_id."""
...
def test_inventory_db_product_insert_data(
    ...
    """Test inserting data into product table."""
...
@pytest.mark.dbfixture
@pytest.mark.parametrize(
    "id, product_inventory, image, alt_text, is_feature, created_at,"
    " updated_at",
    [
        (
            1,
